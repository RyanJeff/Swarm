...
var Beetle01 = [
				...
				[-1, -1], [6, 11], [7, 12], [7, 11], [7, 12], [8, 11], [6, 11]];
 ...
 var Beetle02 = [
				...
				[-1, -1], [6, 11], [6, 12], [7, 11], [8, 12], [8, 11], [6, 11]];
...
var LetterB02 = [
                     [-1, -1], [0, 0], [0, 8], [5, 8], [7, 7], [8, 6], [8, 5], [7, 4],
                     [8, 3], [8, 2], [7, 1], [4, 0], [0, 0], [0, 1], [-1, -1], [2, 1],
                     [2, 3], [6, 3], [6, 2], [3, 1], [2, 1], [-1, -1], [2, 5], [2, 7],
                     [4, 7], [6, 6], [6, 5], [2, 5], [2, 6]];

var LetterC01 = [
					[-1, -1], [0, 0], [0, 0], [0, 2], [0, 2], [0, 6], [0, 6], [0, 8], [0, 8], [0, 0], [0, 0]];
var LetterC02 = [
					[-1, -1], [0, 0], [8, 0], [8, 2], [2, 2], [2, 6], [8, 6], [8, 8], [0, 8], [0, 0], [1, 0]];
...
var LetterE01 = [
					[-1, -1], [0, 0], [0, 8], [0, 8], [0, 6], [0, 6], [0, 5], [0, 5], 
                    [0, 3], [0, 3], [0, 2], [0, 2], [0, 0], [0, 0], [0, 1]];
var LetterE02 = [
					[-1, -1], [0, 0], [0, 8], [8, 8], [8, 6], [2, 6], [2, 5], [6, 5], 
                    [6, 3], [2, 3], [2, 2], [8, 2], [8, 0], [0, 0], [0, 1]];
...
var LetterK02 = [
                    [-1, -1], [0, 0], [0, 8], [2, 8], [2, 5], [3, 5], [3, 6], [4, 6], [4, 7],
                    [5, 7], [5, 8], [7, 8], [7, 6], [6, 6], [6, 5], [5, 5], [5, 4], [4, 4],
                    [4, 3], [5, 3], [5, 2], [6, 2], [6, 1], [7, 1], [7, 0], [4, 0], [4, 1],
                    [3, 1], [3, 2], [2, 2], [2, 0], [0, 0], [0, 2]];
...
var LetterO01 = [
					[-1, -1], [0, 0], [0, 1], [0, 1], [0, 2], [0, 2], [0, 6], [0, 6],
                    [0, 7], [0, 7], [0, 8], [0, 8], [0, 7], [0, 7], [0, 6], [0, 6],
                    [0, 2], [0, 2], [0, 1], [0, 1], [0, 0], [0, 0], [0, 1], [-1, -1],
                    [0, 2], [0, 3], [0, 3], [0, 5], [0, 5], [0, 6], [0, 6], [0, 5],
                    [0, 5], [0, 3], [0, 3], [0, 2], [0, 2]];
var LetterO02 = [
					[-1, -1], [2, 0], [2, 1], [1, 1], [1, 2], [0, 2], [0, 6], [1, 6],
                    [1, 7], [2, 7], [2, 8], [6, 8], [6, 7], [7, 7], [7, 6], [8, 6],
                    [8, 2], [7, 2], [7, 1], [6, 1], [6, 0], [2, 0], [2, 1], [-1, -1],
                    [3, 2], [3, 3], [2, 3], [2, 5], [3, 5], [3, 6], [5, 6], [5, 5],
                    [6, 5], [6, 3], [5, 3], [5, 2], [3, 2]];

var LetterP02 = [
                    [-1, -1], [0, 0], [0, 8], [2, 8], [2, 5], [4, 5], [7, 4],
                    [8, 3], [8, 2], [7, 1], [4, 0], [0, 0], [0, 1], [-1, -1],
                    [2, 1], [2, 4], [4, 4], [6, 3], [6, 2], [4, 1], [2, 1]];
...
var LetterR01 = [
					[-1, -1], [0, 0], [0, 8], [0, 8], [0, 4], [0, 4], [0, 5], [0, 5],
                    [0, 6], [0, 6], [0, 7], [0, 7], [0, 8], [0, 8], [0, 6], [0, 6],
                    [0, 5], [0, 5], [0, 4], [0, 4], [0, 3], [0, 3], [0, 1], [0, 1],
                    [0, 0], [0, 0], [0, 1], [-1, -1], [0, 1], [0, 3], [0, 3], [0, 2],
                    [0, 1], [0, 1]];
var LetterR02 = [
					[-1, -1], [0, 0], [0, 8], [2, 8], [2, 4], [3, 4], [3, 5], [4, 5],
                    [4, 6], [5, 6], [5, 7], [6, 7], [6, 8], [8, 8], [8, 6], [7, 6],
                    [7, 5], [6, 5], [6, 4], [7, 4], [7, 3], [8, 3], [8, 1], [7, 1],
                    [7, 0], [0, 0], [0, 1], [-1, -1], [2, 1], [2, 3], [5, 3], [6, 2],
                    [5, 1], [2, 1]];

var LetterS02 = [
					[-1, -1], [6, 2], [6, 3], [8, 3], [8, 1], [7, 0], [1, 0], [0, 1],
                    [0, 3], [1, 4], [3, 5], [5, 5], [6, 6], [5, 7], [3, 7], [2, 6],
                    [2, 5], [0, 5], [0, 7], [1, 8], [7, 8], [8, 7], [8, 5], [7, 4],
                    [5, 3], [3, 3], [2, 2], [3, 1], [5, 1], [6, 2], [6, 3]];

var LetterT01 = [
					[-1, -1], [0, 0], [0, 2], [0, 2], [0, 8], [0, 8], [0, 2], [0, 2], [0, 0], [0, 0], [0, 1]];
var LetterT02 = [
					[-1, -1], [0, 0], [0, 2], [3, 2], [3, 8], [5, 8], [5, 2], [8, 2], [8, 0], [0, 0], [0, 1]];
...
var LetterV01 = [
					[-1, -1], [0, 0], [0, 8], [0, 8], [0, 0], [0, 0], [0, 6], [0, 0], [0, 0], [0, 8]];

var LetterV02 = [
					[-1, -1], [0, 0], [3, 8], [5, 8], [8, 0], [6, 0], [4, 6], [2, 0], [0, 0], [3, 8]];
...
var NumberTwo02 = [
                        [-1, -1], [0, 3], [0, 2], [1, 2], [1, 1], [2, 1],
                        [2, 0], [6, 0], [6, 1], [7, 1], [7, 2], [8, 2],
                        [8, 4], [7, 4], [7, 5], [5, 5], [5, 6], [4, 6],
                        [4, 7], [6, 7], [6, 6], [8, 6], [8, 8], [0, 8],
                        [0, 6], [2, 6], [2, 5], [3, 5], [3, 4], [4, 4],
                        [4, 3], [5, 3], [5, 2], [3, 2], [3, 3], [2, 3],
                        [2, 4], [0, 4], [0, 2]];
...
var NumberFive02 = [
                        [-1, -1], [8, 0], [8, 2], [2, 2], [2, 3], [6, 3],
                        [8, 5], [8, 6], [6, 8], [2, 8], [0, 6], [0, 5],
                        [2, 5], [3, 6], [5, 6], [6, 5], [5, 4], [0, 4],
                        [0, 0], [8, 0]];
...
var VBubble01 = [
					[-1, -1], [0, 2], [2, 0], [6, 0], [8, 2], [8, 6], [6, 8], [2, 8], [0, 6], [0, 2], 
					[-1, -1], [2, 1], [3, 7], [5, 7], [6, 1], [5, 1], [4, 6], [3, 1], [2, 1]];
...
var EBubble01 = [
					[-1, -1], [0, 2], [2, 0], [6, 0], [8, 2], [8, 6], [6, 8], [2, 8], [0, 6], [0, 2], 
					[-1, -1], [2, 1], [2, 7], [6, 7], [6, 6], [3, 6], [3, 5], [5, 5], [5, 3], [3, 3], [3, 2], [6, 2], [6, 1], [2, 1]];
...
var CBubble01 = [
					[-1, -1], [0, 2], [2, 0], [6, 0], [8, 2], [8, 6], [6, 8], [2, 8], [0, 6], [0, 2],
					[-1, -1], [2, 1], [2, 7], [6, 7], [6, 6], [3, 6], [3, 2], [6, 2], [6, 1], [2, 1]];
...
var TBubble01 = [
					[-1, -1], [0, 2], [2, 0], [6, 0], [8, 2], [8, 6], [6, 8], [2, 8], [0, 6], [0, 2], 
					[-1, -1], [2, 1], [2, 2], [3, 2], [3, 7], [5, 7], [5, 2], [6, 2], [6, 1], [2, 1]];
...
var OBubble01 = [
					[-1, -1], [0, 2], [2, 0], [6, 0], [8, 2], [8, 6], [6, 8], [2, 8], [0, 6], [0, 2], 
					[-1, -1], [2, 1], [2, 7], [6, 7], [6, 1], [2, 1], 
					[-1, -1], [3, 2], [3, 6], [5, 6], [5, 2], [3, 2]];
...
var RBubble01 = [
					[-1, -1], [0, 2], [2, 0], [6, 0], [8, 2], [8, 6], [6, 8], [2, 8], [0, 6], [0, 2], 
					[-1, -1], [2, 1], [2, 7], [3, 7], [3, 4], [4, 4], [5, 7], [6, 7], [5, 4], [6, 4], [6, 1], [2, 1], 
					[-1, -1], [3, 2], [3, 3], [5, 3], [5, 2], [3, 2]];
