...
var LetterB02 = [
                     [-1, -1], [0, 0], [0, 8], [8, 8], [8, 6], [6, 4], [8, 2], [6, 0], [0, 0], [-1, -1], [2, 5], [2, 7], [5, 7], [6, 6], [5, 5], [2, 5], [-1, -1], [2, 1], [2, 3],
                     [5, 3], [6, 2], [5, 1], [2, 1]];
...
var LetterD02 = [
                    [-1, -1], [0, 0], [0, 8], [6, 8], [6, 7], [7, 7], [7, 6], [8, 6], [8, 2], [7, 2], [7, 1],
                    [6, 1], [6, 0], [0, 0], [-1, -1], [2, 2], [2, 6], [5, 6], [5, 5], [6, 5], [6, 3], [5, 3],
                    [5, 2], [2, 2]];
...
var LetterF02 = [
                     [-1, -1], [0, 0], [0, 8], [2, 8], [2, 5], [6, 5], [6, 3], [2, 3], [2, 2], [8, 2], [8, 0], [0, 0]];
...
var LetterH02 = [
                    [-1, -1], [0, 0], [0, 8], [2, 8], [2, 5], [6, 5], [6, 8], [8, 8], [8, 0], [6, 0], [6, 3], [2, 3], [2, 0]];

var LetterI02 = [
                    [-1, -1], [0, 0], [8, 0], [8, 2], [5, 2], [5, 6], [8, 6], [8, 8], [0, 8], [0, 6], [3, 6], [3, 2], [0, 2], [0, 0]];
...
var LetterK02 = [
                    ...
                    [6, 2], [6, 1], [4, 1], [4, 2], [3, 2], [3, 3], [2, 3], [2, 0], [0, 0]];

var LetterL02 = [
                    [-1, -1], [0, 0], [0, 8], [7, 8], [7, 6], [2, 6], [2, 0], [0, 0]];

var LetterM02 = [
                    [-1, -1], [0, 0], [0, 8], [2, 8], [2, 4], [3, 4], [3, 6], [5, 6], [5, 4], [6, 4], [6, 8], [8, 8], [8, 0], [6, 0],
                    [6, 1], [5, 1], [5, 2], [3, 2], [3, 1], [2, 1], [2, 0], [0, 0]];
...
var LetterQ02 = [
                    ...
                    [2, 0], [2, 1], [1, 1], [1, 2], [0, 2], [-1, -1], [4, 6],
                    [-1, -1], [3, 6], [5, 6], [5, 5], [6, 5], [6, 3], [5, 3],
                    [5, 2], [3, 2], [3, 3], [2, 3], [2, 5], [3, 5], [3, 6]];
...
var LetterW02 = [
                    [-1, -1], [0, 0], [0, 8], [8, 8], [8, 0], [6, 0], [6, 6], [5, 6], [5, 2], [3, 2], [3, 6], [2, 6], [2, 0], [0, 0]];
